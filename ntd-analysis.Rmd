...
employee.fatality.pmt.8avg <- ntd.average("Total.Employee", "Passenger.Miles.Traveled.safety", 2008, 2015, 10**9)
```
...
employee.injury.pmt.8avg <- ntd.average("Total.Employee.1", "Passenger.Miles.Traveled.safety", 2008, 2015, 10**9)
```
...
people.waiting.leaving.fatality.pmt.8avg <- ntd.average("People.waiting.or.leaving", "Passenger.Miles.Traveled.safety", 2008, 2015, 10**9)
```
...
people.waiting.leaving.injury.pmt.8avg <- ntd.average("People.waiting.or.leaving.1", "Passenger.Miles.Traveled.safety", 2008, 2015, 10**9)
```
...
```{r, echo=FALSE}
employee.fatality.pmt.8avg %>%
  merge(employee.injury.pmt.8avg, by="acronym", suffixes=c("","employeeinjury")) %>%
  merge(people.waiting.leaving.fatality.pmt.8avg, by="acronym", suffixes=c("","peoplewaitingorleavingfatality")) %>%
  merge(people.waiting.leaving.injury.pmt.8avg, by="acronym", suffixes=c("","peoplewaitingorleavinginjury")) %>%
  arrange(acronym) %>%
  gather(var, val, 2:ncol(.)) %>%
  mutate(var = recode(var, average="Employee fatalities per billion passenger miles", averageemployeeinjury="Employee injuries per billion passenger miles", averagepeoplewaitingorleavingfatality="People waiting or leaving fatalities per billion passenger miles", averagepeoplewaitingorleavinginjury="People waiting or leaving injuries per billion passenger miles")) %>%
  spread(acronym, val) %>%
  kable(format.args = list(big.mark=","))
```